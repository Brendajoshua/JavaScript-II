...
//filter out runners whose donations were greater tha 100
//console.log}
let donationOver100 = [];
donationOver100 = runners.filter(runner => runner.donation > 100);
console.log(donationOver100);
// Problem 2
//Declare a variable,set it to an empty array
//map over runners only showing email
//console.log
let runnerEmail = [];
runnerEmail = runners.map( runner => runner.email);
